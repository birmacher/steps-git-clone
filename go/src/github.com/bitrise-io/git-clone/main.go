...
func main() {
	...
	pullRequestURI := os.Getenv("pull_request_uri")
	pullRequestBranch := os.Getenv("pull_request_branch")
	...
	git.ConfigureCheckout(pullRequestID, pullRequestURI, pullRequestBranch, commit, tag, branch, cloneDepth)
